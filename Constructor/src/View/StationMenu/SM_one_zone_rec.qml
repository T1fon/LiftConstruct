...
Rectangle
{
    ...
    Rectangle
    {
        id: package_view_rec
        width: parent.width
        y: package_viev_header_rec.height + package_viev_header_rec.y
        height: 0
        color: "#D9D9D9"
        visible: false
        enabled: false
